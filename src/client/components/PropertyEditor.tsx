...
const saveBtnStyle: React.CSSProperties = { padding: '8px 16px', borderRadius: 8, border: 'none', background: '#00d9ff', color: '#0a1628', fontWeight: 600, cursor: 'pointer', fontSize: 13 };
