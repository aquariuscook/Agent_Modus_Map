...
body{background:linear-gradient(135deg,#0a1628 0%,#1a1f3a 50%,#0a1628 100%);font-family:'Segoe UI',system-ui,sans-serif;min-height:100vh;padding:40px 20px;color:#fff}
