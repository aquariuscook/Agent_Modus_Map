...
const DEFAULT_CORE_TASKS: Record<string, string> = {
  ...
  // Lead Gen Dashboard
  Command: 'Take ALL upstream agent outputs and compile into structured JSON. For EVERY prospect company found, extract: companyName, website, industry, location, employeeCount, revenueEstimate, leadScore (1-10), buyingSignals (array), contactName, contactTitle, contactEmail. Do NOT generate outreach emails. Do NOT construct LinkedIn URLs. Include as many prospects as possible. Be concise. Output ONLY valid JSON: {"prospects":[{...},...]}\nNo markdown, no explanation, just JSON.',
};
